...
HD_PWD='E:/cnn-FPGA/code/test/CNN_FPGA/CNN_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floatAdd16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floatAdd16.tcl
